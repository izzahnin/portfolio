...
export const listIcon: IconItem[] = [
  ...
  { id: 7,  name: "Tailwind CSS", svg: "/icons/tailwindcss.svg", color: "#38B2AC", category: "frontend" },
  { id: 5,  name: "Node.js",      svg: "/icons/nodejs.svg",      color: "#339933", category: "backend"  },
  ...
  { id: 18, name: "Material UI", svg: "/icons/materialui.svg", color: "#0081CB", category: "frontend" },
  ...
  { id: 23, name: "Redis", svg: "/icons/redis.png", color: "#DC382D", category: "database" },
  { id: 24, name: "Gin", svg: "/icons/gin.png", color: "#00C1D4", category: "backend" },
  { id: 25, name: "Supabase", svg: "/icons/supabase.png", color: "#3ECF8E", category: "database" },
  { id: 26, name: "TanStack Table", svg: "/icons/tanstackquery.png", color: "#FF4154", category: "frontend" },
  { id: 27, name: "Firebase", svg: "/icons/firebase.png", color: "#FFCA28", category: "cloud" },
  { id: 28, name: "Prisma", svg: "/icons/prisma.png", color: "#2D3748", category: "database" },
];
