export type IconCategory = "frontend" | "backend" | "cloud";
...
export const listIcon: IconItem[] = [
  ...
  { id: 12, name: "MySQL",       svg: "/icons/mysql.svg",       color: "#4479A1", category: "backend"  },
  { id: 13, name: "Docker",      svg: "/icons/docker.svg",      color: "#2496ED", category: "cloud"    },
  { id: 9,  name: "Git",         svg: "/icons/git.svg",         color: "#F05032", category: "cloud"    },
  { id: 10, name: "Postman",     svg: "/icons/postman.svg",     color: "#FF6C37", category: "cloud"    },
  { id: 14, name: "VS Code",     svg: "/icons/vscode.svg",      color: "#007ACC", category: "cloud"    },
  { id: 16, name: "Google Cloud Platform", svg: "/icons/gcp.png", color: "#4285F4", category: "cloud" },
  { id: 17, name: "PostgreSQL", svg: "/icons/postgresql.webp", color: "#336791", category: "backend" },
  { id: 18, name: "MaterialUI", svg: "/icons/materialui.svg", color: "#0081CB", category: "frontend" },
  { id: 19, name: "DBeaver", svg: "/icons/dbeaver.svg", color: "#4C4C4C", category: "backend" },
