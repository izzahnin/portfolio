      ...
      <Reveal>
        <section className="flex flex-col items-center gap-3 md:items-start">
          <div className="flex items-center gap-2">
            <h2 className="font-display text-3xl font-semibold text-[var(--text-primary)]">Contact</h2>
          ...
          <p className="max-w-2xl text-center text-base text-[var(--text-secondary)] md:text-left">
            Open to full-stack developer roles and collaborative product teams.
          </p>
        </section>
      </Reveal>
        ...
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between">
          <div className="flex flex-col gap-4">
            ...
            <p className="max-w-md text-[var(--text-secondary)]">
              If you&apos;re hiring for a web development role or want to discuss a project,
